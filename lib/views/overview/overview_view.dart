...
class Overview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scriptName = navController.selectedScript.value;
    OverviewController overviewController =
        Get.find<OverviewController>(tag: scriptName);
    if (!Get.isRegistered<TaskDashboardController>(tag: scriptName)) {
      Get.put(TaskDashboardController(), tag: scriptName, permanent: true);
    }
    TaskDashboardController tdController =
        Get.find<TaskDashboardController>(tag: scriptName);
        ...
        child: <Widget>[
          ...
          Obx(() {
            return LogWidget(
                    ...
                    title: I18n.log.tr,
                    enableCollapse: false,
                    topPanelBottomChild: tdController.taskCardMap.isNotEmpty
